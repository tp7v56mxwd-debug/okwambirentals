...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-[9999] w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-luxury hover:shadow-glow transition-all duration-300 flex items-center justify-center group hover:scale-110"
