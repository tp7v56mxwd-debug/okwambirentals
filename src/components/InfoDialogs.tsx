    ...
    <DropdownMenu>
      ...
      >
        <DropdownMenuItem asChild>
          <Link 
            to="/faq"
            className="cursor-pointer rounded-lg py-3 px-4 text-sm font-medium transition-all hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary flex items-center"
          >
